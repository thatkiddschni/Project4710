...
<body>
	...
	<label>admin id</label> <input type="text" name="admin_id" value="<?php echo $e_title; ?>">
	<br>
	<label>user id</label> <input type="text" name="user_id" value="<?php echo $e_title; ?>">
	<br>
                            ...
                            <section class="w3-col m6">
                                <form class="form-container">
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control" placeholder="knitro@ucf.knights.edu"
                        ...
                        <section class="row justify-content-center">
                            <section class="w3-col m6">
                                <form class="form-container">
                                    <h1>Sign up</h1>
                                    <div class="form-group">
                                        <input type="username" class="form-control" placeholder="John"
                                            id="usernameInput">
                                        <label for="usernameInput">Username</label>
                                    </div>
                                    <div class="form-group">
                                        <input type="email" class="form-control" placeholder="Smith"
                                            id="exampleInputEmail1" aria-describedby="emailHelp">
                                        <label for="exampleInputEmail1">Email address</label>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <input type="userType" class="form-control" placeholder="User" id="userInput">
    ...
    <div class="w3-container w3-content w3-padding-64" style="max-width:800px">
        ...
        <form>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="validationDefault02" placeholder="Event Link" required>
            </div>
            <div class="form-row">
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	$admin_id = parse_inp($_POST["admin_id"]);
	$user_id = parse_inp($_POST["user_id"]);
}
...
if (!empty($admin_id)) {
	$sql = "SELECT * FROM events WHERE organizer_id = " . $admin_id;
	if ($_SERVER["REQUEST_METHOD"] == "POST") {
...
if (!empty($user_id)) {
	$sql = "select distinct * from gph.events where id in (select event_id from gph.registrations where user_id = " . $user_id . ")";
	if ($_SERVER["REQUEST_METHOD"] == "POST") {
		$result = $connection->query($sql);
		while ($row = $result->fetch_assoc()) {
			echo "id: " . $row["id"] . " org-id: " . $row["organizer_id"] . " name " . $row["event_name"] . " location " . $row["event_name"] . " desc " . $row["description"] . " sdate " . $row["start_date"] . " edate " . $row["end_date"] . " url " . $row["url"] . " city " . $row["city"];
